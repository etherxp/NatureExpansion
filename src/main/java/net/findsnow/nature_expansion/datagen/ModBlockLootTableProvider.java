...
import net.findsnow.nature_expansion.block.ModMapleLeafLitterBlock;
...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
	...
	protected void generate() {
		...
		this.add(ModBlocks.MAPLE_LEAF_LITTER.get(), this.createPetalsDrops(ModBlocks.MAPLE_LEAF_LITTER.get()));
